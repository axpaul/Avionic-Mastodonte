...
- **Détection du décollage**  
  ...
  - Un **capteur inertiel externe** (accéléromètre ou contacteur) peut également fournir le signal de décollage.
  Dans les deux cas, la carte enregistre précisément le moment du décollage pour initier la suite des opérations.
...
- **Fenêtrage temporel autour de l’apogée**  
  ...
  - La carte est à l’écoute d’un éventuel signal d’apogée transmis par une électronique extérieure (par exemple via un optocoupleur).
  - Cela permet de prévenir toute **détection erronée** en dehors de cette phase critique.
...
- **Déploiement des systèmes de récupération**  
  Sur événement valide (ou par sécurité), Mastodonte pilote des **charges pyrotechniques ou moteurs DC** pour déployer les parachutes, filets ou tout autre système de récupération.

- **Enregistrement des données critiques**  
  À chaque étape, Mastodonte journalise les événements clés du vol :
  - heure de détection du décollage,
